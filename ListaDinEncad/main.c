#ifndef listaDinEncad.h
#define listaDinEncad.h
#endif
...
/*li é um ponteiro pra Lista, mas Lista é um "struct elemento*", ou seja, tbm é um ponteiro.
Por isso, temos que *li é um  ponteiro para ponteiro, para a minha struct elemento*.
Um ponteiro para ponteiro consegue guardar dentro dele um endereço para outro ponteiro.
Tenho que o inicio da lista é "li**", que aponta para o primeiro elemento, que contem um campo de dados e um campo "próximo" que é um ponteiro para o proximo elemento. */
Lista *li;
